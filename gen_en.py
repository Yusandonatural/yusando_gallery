...
<header class="site-header">
  <div class="nav-wrap">
    <a class="brand" href="{root}en/index.html" aria-label="Cerendipity — Yusando Antique Gallery">
      ...
      <span class="brand-ja">Yusando Antique Gallery</span>
    </a>
...
<div class="detail-body">
  ...
  <section class="d-sec reveal">
    <h2>Gallery <span class="en-sub">この道具のギャラリー</span></h2>
    <div class="d-rule"></div>
...
# ---------------------------------------------------------------- page list ----
# Post-processing (language switcher, hreflang, typography, sitemap) now lives
# in l10n.py so every language edition is handled by one piece of code.
PAGES_JA_EN = ["index.html","tools.html","setup.html","guide.html","articles/index.html",
  "articles/chawan-types.html","articles/history.html","articles/chasen-types.html",
  "articles/sekki.html","articles/evolution.html","articles/kama-types.html",
  "articles/chaire-types.html","articles/natsume-types.html"] + \
  [f"tools/{t['slug']}.html" for t in TOOLS_EN]

if __name__ == "__main__":
    print("EN pages written; run build.py to post-process every language.")
