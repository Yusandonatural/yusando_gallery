...
# GitHub Pages / Worker の公開元は docs/。生成物はすべてここに書き出す。
...
import shutil
for _d in ("css", "assets"):
    _src = os.path.join(BASE, _d)
    if os.path.isdir(_src):
        shutil.copytree(_src, os.path.join(ROOT, _d), dirs_exist_ok=True)
        print("copied", _d + "/")
w("CNAME", "gallery.yusando.com\n")
w(".nojekyll", "")   # Worker/Pages とも Jekyll を通さない
